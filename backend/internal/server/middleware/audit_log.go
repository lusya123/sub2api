...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/security-audit-logs/clear":            service.AuditActionAuditLogClear,
	"POST /api/v1/admin/audit-logs/clear":                     service.AuditActionAuditLogClear, // 旧版兼容别名
