...
func TestGetUserGroupRateMultiplier_CacheHitAndNilRepo(t *testing.T) {
	...
	key := "101:202"
	svc.userGroupRateCache.Set(key, &UserGroupRateConfig{RateMultiplier: 2.3}, time.Minute)
	...
	svc2.userGroupRateCache.Set(key, &UserGroupRateConfig{RateMultiplier: 1.9}, time.Minute)
