...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyCustomerServiceQRCode,
		SettingKeyDocURL,
	...
	return &PublicSettings{
		...
		CustomerServiceQRCode:            settings[SettingKeyCustomerServiceQRCode],
...
func (s *SettingService) GetModelHealthPageRuntime(ctx context.Context) ModelHealthPageRuntime {
	...
	return ModelHealthPageRuntime{Enabled: !isFalseSettingValue(vals[SettingKeyModelHealthPageEnabled])}
}
