...
const apiKeyAuthSnapshotVersion = 18 // v18: include group reasoning policy and the OpenAI group Live gate
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ActualRateMultiplier:            apiKey.Group.ActualRateMultiplier,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ActualRateMultiplier:            snapshot.Group.ActualRateMultiplier,
