...
const (
	...
	SettingKeyChatPageEnabled                  = "chat_page_enabled"                   // 是否启用用户端聊天页面入口
	SettingKeyChatPageURL                      = "chat_page_url"                       // 用户端聊天页面跳转地址
	SettingKeyAgentPageEnabled                 = "agent_page_enabled"                  // 是否启用用户端 Agent 应用入口
	SettingKeyAgentPageURL                     = "agent_page_url"                      // 用户端 Agent 应用跳转地址
	...
	SettingKeyCustomerServiceQRCode           = "customer_service_qrcode"            // 客服微信二维码 (base64/data URL)
	...
	SettingKeyPurchaseSubscriptionEmbeddedURL = "purchase_subscription_embedded_url" // "购买订阅"内嵌 URL
	SettingKeyPurchaseSubscriptionRedirectURL = "purchase_subscription_redirect_url" // "购买订阅"跳转 URL
