...
type Group struct {
	...
	// ActualRateMultiplier holds the value of the "actual_rate_multiplier" field.
	ActualRateMultiplier *float64 `json:"actual_rate_multiplier,omitempty"`
	// 是否向普通用户展示 usage 费用明细表
	ShowCostBreakdown bool `json:"show_cost_breakdown,omitempty"`
	// 是否启用高峰时段倍率
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldShowCostBreakdown, group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldActualRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldActualRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field actual_rate_multiplier", values[i])
			} else if value.Valid {
				_m.ActualRateMultiplier = new(float64)
				*_m.ActualRateMultiplier = value.Float64
			}
		case group.FieldShowCostBreakdown:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field show_cost_breakdown", values[i])
			} else if value.Valid {
				_m.ShowCostBreakdown = value.Bool
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ActualRateMultiplier; v != nil {
		builder.WriteString("actual_rate_multiplier=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	builder.WriteString("show_cost_breakdown=")
	builder.WriteString(fmt.Sprintf("%v", _m.ShowCostBreakdown))
	builder.WriteString(", ")
