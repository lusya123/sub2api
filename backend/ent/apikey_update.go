...
func (_u *APIKeyUpdate) SetType(v string) *APIKeyUpdate {
	_u.mutation.SetType(v)
	return _u
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableType(v *string) *APIKeyUpdate {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
...
// SetType sets the "type" field.
func (_u *APIKeyUpdateOne) SetType(v string) *APIKeyUpdateOne {
	_u.mutation.SetType(v)
	return _u
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableType(v *string) *APIKeyUpdateOne {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
