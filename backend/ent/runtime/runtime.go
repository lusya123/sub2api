...
func init() {
	...
	apikeyDescType := apikeyFields[3].Descriptor()
	...
	// apikey.TypeValidator is a validator for the "type" field. It is called by the builders before save.
	apikey.TypeValidator = apikeyDescType.Validators[0].(func(string) error)
	...
	// groupDescShowCostBreakdown is the schema descriptor for show_cost_breakdown field.
	groupDescShowCostBreakdown := groupFields[4].Descriptor()
	// group.DefaultShowCostBreakdown holds the default value on creation for the show_cost_breakdown field.
	group.DefaultShowCostBreakdown = groupDescShowCostBreakdown.Default.(bool)
	...
	// userDescLegacyShopPasswordHash is the schema descriptor for legacy_shop_password_hash field.
	userDescLegacyShopPasswordHash := userFields[2].Descriptor()
	// user.LegacyShopPasswordHashValidator is a validator for the "legacy_shop_password_hash" field. It is called by the builders before save.
	user.LegacyShopPasswordHashValidator = userDescLegacyShopPasswordHash.Validators[0].(func(string) error)
	// userDescCredentialVersion is the schema descriptor for credential_version field.
	userDescCredentialVersion := userFields[3].Descriptor()
	// user.DefaultCredentialVersion holds the default value on creation for the credential_version field.
	user.DefaultCredentialVersion = userDescCredentialVersion.Default.(uint64)
