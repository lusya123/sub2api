  ...
  <header class="app-topbar">
    <div class="app-topbar__inner">
      ...
      <div class="app-topbar__actions">
        ...
        <div
          v-if="user"
          class="app-topbar__balance group relative hidden items-center gap-2 rounded-xl bg-primary-50 px-3 py-1.5 dark:bg-primary-900/20 sm:flex"
          :title="formatHeaderMoney(availableBalance)"
        >
          <svg
...
const customerServiceQrcode = computed(() => sanitizeUrl(appStore.customerServiceQrcode?.trim() || '', { allowRelative: true, allowDataUrl: true }))
