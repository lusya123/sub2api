<template>
  <div class="flex min-w-0 flex-1 items-start justify-between gap-3">
    ...
    <div class="flex shrink-0 items-center gap-2 pt-0.5">
      ...
      <span v-if="showRatePill && rateMultiplier !== undefined" :class="['inline-flex items-center whitespace-nowrap rounded-full px-3 py-1 text-xs font-semibold', ratePillClass]">
