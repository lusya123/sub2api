export default {
  ...
  modelMarketplaceStatus: {
    ...
    squareHeading: 'Model Marketplace',
    ...
    ratedPrice: 'x{rate}',
    discount: 'Discount',
    channelFinalPrice: 'Channel price',
    officialDiscount: 'Official discount',
    officialPrice: 'Official price',
    exchangeDiscount: 'Exchange discount',
    officialInputPrice: 'Official input',
    officialOutputPrice: 'Official output',
    officialRequestPrice: 'Official request',
    officialImagePrice: 'Official image',
    officialDiscountValue: '{discount}/10 official price',
    exchangeDiscountValue: '{discount}/10 exchange price',
    rateDiscountValue: 'Rate {discount}/10',
    finalDiscountValue: 'Final {discount}/10',
    exchangeRateHint: 'at $1Ŵ{rate}',
    officialSavingValue: 'Save {saving}%',
  ...
  admin: {
    ...
    channelMonitor: {
      ...
      effectiveRateRequired: 'Please enter a model marketplace rate greater than 0',
      columns: {
        name: 'Name',
        provider: 'Provider',
        primaryModel: 'Primary Model',
    ...
    // Model Marketplace Monitor (independent copy)
    modelMarketplaceMonitor: {
      title: 'Model Marketplace',
      description: 'Manage model marketplace availability, latency, and display status',
      searchPlaceholder: 'Search monitor name...',
      allProviders: 'All Providers',
      allStatus: 'All Status',
      enabledFilter: 'Enabled',
      ...
      onlyDisabled: 'Disabled only',
      createButton: 'Create Monitor',
      createTitle: 'Create Model Marketplace Monitor',
      editTitle: 'Edit Model Marketplace Monitor',
      runNow: 'Run Now',
      runSuccess: 'Check completed',
      runFailed: 'Check failed',
      apiKeyDecryptFailed: 'API Key decryption failed. Please re-edit this monitor with a fresh key.',
      ...
      nameRequired: 'Please enter a monitor name',
      primaryModelRequired: 'Please enter a primary model',
      invalidPricing: 'Please enter model original prices greater than or equal to 0',
      columns: {
        name: 'Name',
        provider: 'Provider',
        primaryModel: 'Primary Model',
      ...
      form: {
        ...
        displayNameHint: 'Display names only affect the model marketplace page. Chinese UI prefers Chinese names and falls back to English names. If no display name is configured, the user side does not show a model title.',
        callModel: 'Full call model name',
        requestUrl: 'Full request URL',
        callConfigHint: 'The call model and request URL are shown to users for copy-and-configure flows. If left blank, the model ID is used and the current project default OpenAI/Anthropic/Gemini endpoint is inferred. You can create multiple monitor channels with the same full call model name; the user page will merge them and show each channel rate, price and health bar.',
        customPricing: 'Custom model original price',
        customPricingHint: 'Enter USD prices per 1M tokens. Leave blank to keep using the built-in/New API default price. When filled, the user-side original price and channel final price are calculated from this value.',
        ...
        effectiveRateHint: 'Only affects marketplace channel price and discount display. Defaults to 1 and does not read group-management rates.',
        intervalSeconds: 'Interval (seconds)',
        intervalSecondsHint: 'Range: 15 - 3600 seconds',
        enabled: 'Enable monitor',
        kindRequired: 'Please select a provider'
