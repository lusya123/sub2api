export default {
  ...
  admin: {
    ...
    settings: {
      ...
      purchase: {
        ...
        description: 'Show a "Recharge / Subscription" entry in the sidebar and choose between embedded or new-tab open modes',
        enabled: 'Show Recharge / Subscription Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        mode: 'Open Mode',
        modeEmbedded: 'Embedded',
        modeRedirect: 'Open in New Tab',
        modeHint: 'Controls how the sidebar purchase entry opens the payment page',
        modeRequiredHint: 'This URL is required for the current open mode',
        embeddedUrl: 'Embedded Page URL',
        embeddedUrlPlaceholder: 'https://example.com/purchase/embed',
        embeddedUrlHint: 'Used for iframe embedding and must be an absolute http(s) URL',
        redirectUrl: 'Redirect Page URL',
        redirectUrlPlaceholder: 'https://example.com/purchase/topup',
        redirectUrlHint: 'Used for opening a new tab and must be an absolute http(s) URL',
        iframeWarning:
  ...
  purchase: {
    ...
    description: 'Recharge balance or purchase subscription using the administrator-configured payment page',
    openInNewTab: 'Open in new tab',
    openNow: 'Open now',
    redirectTitle: 'Opening payment page',
    redirectDesc: 'This purchase entry is configured to open in a new tab. If your browser did not open it automatically, use the button below.',
