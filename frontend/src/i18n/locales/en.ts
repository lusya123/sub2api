  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_createOrderUrl: 'Create Order URL',
        field_selectOrderUrl: 'Query Order URL',
        field_refundOrderUrl: 'Refund URL',
        field_merchantId: 'Merchant ID',
        field_merchantKey: 'Merchant Key',
        field_reserve: 'Reserve header',
        field_alipayType: 'Alipay type value',
        field_wechatType: 'WeChat type value',
        field_body: 'Order body',
        stripeWebhookHint: 'Configure the following URL as a Webhook endpoint in Stripe Dashboard:',
        thirdpayWebhookHint: 'Configure the following URL as the ThirdPay payment notification endpoint:',
