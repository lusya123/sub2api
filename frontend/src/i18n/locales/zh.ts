  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_createOrderUrl: '创建订单接口',
        field_selectOrderUrl: '查询订单接口',
        field_refundOrderUrl: '退款接口',
        field_merchantId: '商户 ID',
        field_merchantKey: '商户密钥',
        field_reserve: 'Reserve 请求头',
        field_alipayType: '支付宝类型值',
        field_wechatType: '微信类型值',
        field_body: '商品描述',
        stripeWebhookHint: '请在 Stripe Dashboard 中将以下地址配置为 Webhook 端点：',
        thirdpayWebhookHint: '请在 ThirdPay 后台将以下地址配置为支付结果通知地址：',
