export default {
  ...
  redeem: {
    ...
    trialCodeAlreadyUsed: '每个账号只能兑换一次体验码，您已经兑换过体验码了。',
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        rateMultiplier: '费率倍数',
        actualRateMultiplier: '实际扣费倍率',
        showCostBreakdown: '显示费用明细',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      displayRateHint: '用户可见倍率。列表、分组展示等前台信息使用这个倍率。',
      actualRateHint: '真实扣费倍率。按量扣费、月卡额度消耗、usage actual_cost 都按这个倍率计算。',
      showCostBreakdownHint: '控制普通用户在使用记录里点击费用问号时，是否显示输入/输出/缓存成本等费用明细表。',
      actualRateShort: '实扣',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
    ...
    redeem: {
      ...
      trialBadge: '体验码',
      trialCodeLabel: '标记为体验码',
      trialCodeHint: '同一账号只能兑换一次这类兑换码。适合 5 美元新用户体验，不会影响普通充值兑换码。',
      allTypes: '全部类型',
      allStatus: '全部状态',
      unused: '未使用',
      used: '已使用',
      ...
      v2: {
        ...
        pulse: {
          ...
          hint: {
            ...
            trial: {
              up: '体验券消耗用户增加，重点看后续是否转真实付费。',
              down: '体验券消耗下降，检查新用户激活和体验券领取链路。',
              flat: '体验券消耗用户数稳定。'
            },
            paying: {
              up: '真实付费用户增加，订阅或充值入口转化健康。',
              down: '真实付费下滑，检查充值入口和套餐吸引力。',
              flat: '真实付费用户数稳定。'
            }
          }
        },
    ...
    settings: {
      ...
      purchase: {
        title: '充值/订阅页面',
        description: '在侧边栏展示“充值/订阅”入口，并支持后台选择以内嵌或新窗口跳转方式打开',
        enabled: '显示充值/订阅入口',
        enabledHint: '仅在标准模式（非简单模式）下展示',
        mode: '打开方式',
        modeEmbedded: '内嵌显示',
        modeRedirect: '新窗口跳转',
        modeHint: '侧边栏点击“充值/订阅”后，按此方式打开页面',
        modeRequiredHint: '当前打开方式下该地址为必填项',
        embeddedUrl: '内嵌页面 URL',
        embeddedUrlPlaceholder: 'https://example.com/purchase/embed',
        embeddedUrlHint: '用于 iframe 内嵌展示，必须是完整的 http(s) 链接',
        redirectUrl: '跳转页面 URL',
        redirectUrlPlaceholder: 'https://example.com/purchase/topup',
        redirectUrlHint: '用于新窗口打开，必须是完整的 http(s) 链接',
        iframeWarning:
  ...
  purchase: {
    title: '充值/订阅',
    description: '通过管理员配置的页面完成充值或订阅',
    openInNewTab: '新窗口打开',
    openNow: '立即打开',
    redirectTitle: '正在打开充值页面',
    redirectDesc: '当前支付入口已配置为新窗口跳转模式。如果浏览器未自动打开，请点击下方按钮继续。',
