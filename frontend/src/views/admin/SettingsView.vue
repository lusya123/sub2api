...
const allPaymentTypes = computed(() => [
  ...
  { value: "thirdpay", label: t("payment.methods.thirdpay") },
...
const providerKeyOptions = computed(() => [
  ...
  { value: "thirdpay", label: t("admin.settings.payment.providerThirdPay") },
...
function getProviderVisibleMethods(
  ...
  } else if (provider.provider_key === "easypay" || provider.provider_key === "thirdpay") {
